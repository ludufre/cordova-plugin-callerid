...
var getPromisedCordovaExec = function (command, success, fail) {
  ...
  if (success === undefined) {
    if (window.jQuery) {
      ...
      return console.error('CallerID either needs a success callback, or jQuery/AngularJS/Promise/WinJS.Promise defined for using promises');
    }
  }
  // 5th param is NOT optional. must be at least empty array
  cordova.exec(success, fail, "CallerID", command, []);
  return toReturn;
};
